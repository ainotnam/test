---
title: "<span style='color: blue;'>CANCUN</span>: Time-Sensitive Vehicular <span style='color: blue;'>C</span>ontrol and Collaborative Perception via AI-augmented Sustainable Networks"
format:
  html:
    code-fold: true
jupyter: python3
