---
title: "<span style='color: blue;'>CANCUN</span>: Time-Sensitive Vehicular <span style='color: blue;'>C</span>ontrol <span style='color: blue;'>an</span>d <span style='color: blue;'>C</span>ollaborative Perception via AI-augmented S<span style='color: blue;'>u</span>stainable <span style='color: blue;'>N</span>etworks"
format:
  html:
    code-fold: true
jupyter: python3
