---
title: "[CANCUN]{.red}: Time-Sensitive Vehicular Control and Collaborative Perception via AI-augmented Sustainable Networks"
format:
  html:
    code-fold: true
jupyter: python3
...
![My figure caption](./assets/LogoCANCUNpng.png)
